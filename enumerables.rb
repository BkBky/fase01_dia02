...
def odd_integers(array)
  odds_num = []
  array.select { |num| odds_num << num if num.odd? == true }
  odds_num 
end
...
array.find { | i | i if i < limit }
end


#-------------------------

# Dado un array de strings y regresa un nuevo array 
# donde todos los elementos contengan al final un signo de admiración. 
